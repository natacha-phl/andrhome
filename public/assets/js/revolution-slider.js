...
if (1 == window.tplogs) try {
      ...
      var r = {
        ...
        , navigation: {
          ...
          , bullets: {
            ...
            , h_offset: 20
            , v_offset: 0
            , tmp: '<span class="tp-bullet-images"></span><span class="tp-bullet-title"></span>'
          }
          , thumbnails: {
            style: ""
            , enable: !1
            ...
            , wrapper_opacity: 1
            , tmp: '<span class="tp-thumb-images"></span><span class="tp-thumb-title"></span>'
            , visibleAmount: 5
            , hide_onmobile: !1
            , hide_onleave: !0
            , hide_delay: 200
          ...
          , tabs: {
            ...
            , wrapper_color: "#f5f5f5"
            , wrapper_opacity: 1
            , tmp: '<span class="tp-tab-images"></span>'
            , visibleAmount: 5
            , hide_onmobile: !1
            , hide_onleave: !0
            , hide_delay: 200
  ...
  var n = i.is_mobile()
    ...
    , u = function(r, s) {
      if (r == e) return !1;
      if (r.data("aimg") != e && ("enabled" == r.data("aie8") && i.isIE(8) || "enabled" == r.data("amobile") && n) && r.html('<img class="tp-slider-alternative-images" src="' + r.data("aimg") + '">'), r.find(">ul").addClass("tp-revslider-mainul"), s.c = r, s.ul = r.find(".tp-revslider-mainul"), s.cid = r.attr("id"), s.ul.css({
          visibility: "visible"
    ...
    , v = function(r, s) {
      ...
      r.parent().css({
        ...
        i.parent().append('<div class="tp-bgimg defaultimg" style="background-color:' + i.css("backgroundColor") + ";background-repeat:" + a.bgrepeat + ";background-images:url(" + o + ");background-size:" + a.bgfit + ";background-position:" + a.bgposition + ';width:100%;height:100%;"></div>');
