! function() {
  ...
  jQuery.extend(!0, t, {
    ...
    , animateSingleCaption: function(i, n, f, m, w, b, y) {
      ...
      if ("off" == S || I < n.hideCaptionAtLimit && "on" == i.data("captionhidden") || I < n.hideAllCaptionAtLimit ? i.addClass("tp-hidden-caption") : i.removeClass("tp-hidden-caption"), i.data("layertype", "html"), 0 > f && (f = 0), void 0 != i.data("thumbimage") && void 0 == i.data("videoposter") && i.data("videoposter", i.data("thumbimage")), i.hasClass("tp-videolayer") && void 0 != i.data("videoposter") && "on" == i.data("posterOnMobile") && _ISM) {
        ...
        P = parseFloat(A), W = parseFloat(H), i.append('<div class="tp-videoposter" style="position:absolute;top:0px;left:0px;width:100%;height:100%;background-images:url(' + i.data("videoposter") + '); background-size:cover;background-position:center center;"></div>'), i.css("100%" != P ? {
          minWidth: P + "px"
          , minHeight: W + "px"
        } : {
          width: "100%"
  ...
  var a = function(e, t) {
    ...
    , y = function(e, t, a, i, o) {
      var n = "tp-thumb" === i ? ".tp-thumbs" : ".tp-tabs"
        ...
        , l = "tp-thumb" === i ? ".tp-thumb-images" : ".tp-tab-images";
  ...
  jQuery.extend(!0, t, {
    ...
    , manageVideoLayer: function(o, d) {
      ...
      void 0 != o.data("videoposter") && o.data("videoposter").length > 2 ? (0 == o.find(".tp-videoposter").length && o.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-images:url(' + o.data("videoposter") + '); background-size:cover;background-position:center center;"></div>'), 0 == o.find("iframe").length && o.find(".tp-videoposter").click(function() {
